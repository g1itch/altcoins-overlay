...
COMMIT="0529fe23131b1a9ee400392a8898386be7cd362f"
...
SLOT="0"
KEYWORDS="~amd64 ~x86"
IUSE="ssl libressl qt4 ncurses opencl sound qrcode libnotify ${LINGUAS[@]/#/linguas_}"
...
src_prepare() {
	...
	epatch "${FILESDIR}"/0.6.2-notify.patch
