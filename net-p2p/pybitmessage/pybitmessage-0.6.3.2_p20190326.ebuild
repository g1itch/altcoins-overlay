...
COMMIT="acea6831396271b1fb18c5c807bce1168c0ad2eb"
...
SLOT="0"
KEYWORDS="~amd64 ~x86"
IUSE="daemon debug libressl +msgpack systemd libnotify libcanberra ncurses opencl qrcode qt5 sound tor ${LINGUAS[@]/#/l10n_}"
