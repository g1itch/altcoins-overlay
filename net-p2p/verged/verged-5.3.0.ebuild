...
src_install() {
	...
	altcoin_src_install
	ewarn '1. Backup your wallet and/or also the full verge data'
	ewarn '2. Fully remove your blocks and chain state from your disk'
	ewarn '3. either fully re-sync the core node or download the latest blockchain zip from your trusted source'
}
